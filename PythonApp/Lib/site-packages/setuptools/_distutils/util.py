...
def split_quoted (s):
    ...
    be backslash-escaped.  The backslash is stripped from any two-name
    escape sequence, leaving only the escaped name.  The quote
    characters are stripped from any quoted string.  Returns a list of
    words.
    """

    # This is a nice algorithm for splitting up a single string, since it
    # doesn't require name-by-name examination.  It was a little
