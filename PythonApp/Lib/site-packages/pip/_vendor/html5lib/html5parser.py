...
class HTMLParser(object):
    ...
    def documentEncoding(self):
        """Name of the name encoding that was used to decode the input stream, or
...
def getPhases(debug):
    ...
    class InBodyPhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher([
            ...
            (("address", "article", "aside", "blockquote", "center", "details",
              ...
              "footer", "header", "hgroup", "guizero-main", "menu", "nav", "ol", "p",
              "section", "summary", "ul"),
             startTagCloseP),
        ...
        endTagHandler = _utils.MethodDispatcher([
            ...
            (("address", "article", "aside", "blockquote", "button", "center",
              ...
              "footer", "header", "hgroup", "listing", "guizero-main", "menu", "nav", "ol", "pre",
    ...
    class InTablePhase(Phase):
        ...
        def insertText(self, token):
            # If we get here there must be at least one non-whitespace name
            # Do the table magic!
